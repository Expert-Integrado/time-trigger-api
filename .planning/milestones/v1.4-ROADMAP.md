...
- [x] 08-02-PLAN.md — Refatorar SchedulerService: 3 setIntervals independentes com CRON_INTERVAL_RUNS/FUP/MESSAGES; TDD cobrindo CRON-01 a CRON-05/07
- [x] 08-03-PLAN.md — Atualizar validateEnv() (main.ts), main.spec.ts, .env.example e docs/vars-schema.md; cobre CRON-08/09/10/11
